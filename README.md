...
3. Don't use proxy for addresses starting with: https://*
  * Note that this will simulate the real man-in-the-middle situation, as he would not be able to see what happens inside a SSL connection (unless the user ignores the sertificate warning, of course). 
