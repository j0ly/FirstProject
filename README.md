...
In OWASP ZAP, take note of the proxy port number, which can be seen from the "Tools / Options... / Local Proxy" menu.<br>
In the browser: 
* modify the proxy settings to match that port. The proxy server address should be 127.0.0.1.
