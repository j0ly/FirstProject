...
**Note:** Because OWASP ZAP works as a proxy you will see what happens inside the HTTPS connection when you log in to the admin-page! If somebody would, as an example, eavesdrop an unsecure WIFI connection, they would not see the contents of HTTPS traffic. 
