...
* On the Admin page you can get a list of the people who have signed-up.
  ...
  * Here you will first receive a certificate warning as the server is using a self-signed certificate for the https-pages. Continue and ignore the warning!
