...
5. Open “Advanced Cookie Manager” and enter the cookie-session-id into the "Value" box (see [README.md](README.md)), replacing the existing one (delete first, then paste). Save the change.
