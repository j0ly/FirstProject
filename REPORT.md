...
(For example, also the admin password can be seen using OWASP ZAP, but I'm ignoring that intentionally! I have not provided a "how to identify" for that, but I have provided the fix - see A2 or A6!)
