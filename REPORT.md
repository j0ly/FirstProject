...
1. Capture the cookie-session-id with OWASP ZAP when you log in to the Admin pages (see [README.md](README.md#a2)). 
2. Go to the Admin login-page again with Firefox (but don’t log in, - if you are not asked for the credentials then close the browser and try again). 
